...
def test_is_pdf_format(filename, expected_is_pdf_file, file_test_fixtures_directory):
    """
...
def test_is_pdf_format_raise_file_not_found(file_test_fixtures_directory):
    """
