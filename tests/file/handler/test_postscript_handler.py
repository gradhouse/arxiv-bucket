...
def test_is_postscript_format(filename, expected_is_ps_file, file_test_fixtures_directory):
    """
...
def test_is_postscript_raise_file_not_found(file_test_fixtures_directory):
    """
